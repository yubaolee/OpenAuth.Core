...
CREATE TABLE `dataprivilegerule`  (
  ...
  `Enable` bit NOT NULL DEFAULT 1 COMMENT '是否可用',
  `CreateTime` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `CreateUserId` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人ID',
  `CreateUserName` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人',
  `UpdateTime` datetime(0) DEFAULT NULL COMMENT '最后更新时间',
...
CREATE TABLE `resource`  (
  ...
  `TypeName` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '分类名称',
  `TypeId` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '分类ID',
  `Disable` bit NOT NULL DEFAULT 0 COMMENT '是否可用',
  `CreateTime` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `CreateUserId` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人ID',
  `CreateUserName` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人',
  `UpdateTime` datetime(0) DEFAULT NULL COMMENT '最后更新时间',
...
CREATE TABLE `wmscustomermst`  (
  ...
  `IsFactory` bit NOT NULL DEFAULT 0 COMMENT '是否厂家',
  `DeliverRemark` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '配送备注',
  `IsOwner` bit NOT NULL DEFAULT 0 COMMENT '是否货主',
  `IsPurchaser` bit NOT NULL DEFAULT 0 COMMENT '是否供应商',
  `CustProperty` bit NOT NULL DEFAULT 0 COMMENT '客户性质区分',
  ...
  `IsColdDeliver` bit DEFAULT 0 COMMENT '是否冷链配送(0:否,1:是)',
  `CreateTime` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `CreateUserId` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人ID',
  `CreateUserName` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人',
  `UpdateTime` datetime(0) DEFAULT NULL COMMENT '最后更新时间',
...
CREATE TABLE `wmsdelivertbl`  (
  ...
  `CustPickFlg` bit NOT NULL DEFAULT 0 COMMENT '自提标识',
...
CREATE TABLE `wmsgoodsareamst`  (
  ...
  `LotMixtureFlg` bit NOT NULL DEFAULT 0 COMMENT '允许混批',
  `Enable` bit NOT NULL DEFAULT 0 COMMENT '有效标志(SYS_ACTIONFLAG)',
  `NumFlg` bit NOT NULL DEFAULT 0 COMMENT '数量启用标志',
  ...
  `OwnerMixtureFlg` bit NOT NULL DEFAULT 0 COMMENT '是否允许混货主',
  ...
  `ShareFlg` bit NOT NULL DEFAULT 0 COMMENT '共享标志',
...
CREATE TABLE `wmsgoodsmst`  (
  ...
  `BatchFlg` bit NOT NULL DEFAULT 0 COMMENT '同批标志',
  `HoldDays` decimal(16, 0) DEFAULT NULL COMMENT '保质天数',
  `PrintFlg` bit NOT NULL DEFAULT 0 COMMENT '打印标志',
  ...
  `IsBig` bit NOT NULL DEFAULT 1 COMMENT '大单位启用',
  `IsMid` bit NOT NULL DEFAULT 0 COMMENT '中单位启用',
  `IsStand` bit NOT NULL DEFAULT 1 COMMENT '标准单位启用',
  ...
  `IsBigUnit` bit NOT NULL DEFAULT 0 COMMENT '是否大单位核算',
  ...
  `Height` decimal(18, 2) DEFAULT NULL COMMENT '高',
  `InboxFlg` bit NOT NULL DEFAULT 0 COMMENT '是否进箱式立体库',
  `InCacheFlg` bit NOT NULL DEFAULT 0 COMMENT '是否进缓存',
  `BusinessScope` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '经营范围(SYS_JYFW)',
  `IsSkuBarCode` bit NOT NULL DEFAULT 1 COMMENT '是否有条形码',
  `ImportFlg` bit NOT NULL DEFAULT 0 COMMENT '进口标识',
...
CREATE TABLE `wmsgoodsposmst`  (
  ...
  `PutAwayRestricted` bit NOT NULL DEFAULT 0 COMMENT '入库禁用(0:未禁用,1:禁用)',
  `RetrievalRestricted` bit NOT NULL DEFAULT 0 COMMENT '出库禁用(0:未禁用,1:禁用)',
  `SubBayRestricted` bit NOT NULL DEFAULT 0 COMMENT '子货位禁用(0:未禁用,1:禁用)',
  `Empty` bit NOT NULL DEFAULT 0 COMMENT '是否空货位',
  `CreateTime` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `CreateUserId` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人ID',
  `CreateUserName` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人',
  `UpdateTime` datetime(0) DEFAULT NULL COMMENT '最后更新时间',
...
CREATE TABLE `wmsinboundarrivaltbl`  (
  ...
  `Remark` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注',
  `Enable` bit NOT NULL DEFAULT 1 COMMENT '有效标志(SYS_ACTIONFLAG)',
  `IsBatch` bit DEFAULT NULL COMMENT '是否整批处理',
...
CREATE TABLE `wmsinboundorderdtbl`  (
  ...
  `InStockStatus` bit NOT NULL DEFAULT 0 COMMENT '是否收货中(0:非收货中,1:收货中)',
...
CREATE TABLE `wmsinboundordertbl`  (
  ...
  `Enable` bit NOT NULL DEFAULT 1 COMMENT '有效标志',
  `TransferType` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '承运方式',
  `InBondedArea` bit NOT NULL DEFAULT 0 COMMENT '是否入保税库(0:否,1:是)',
...
CREATE TABLE `wmsinstockpickdtbl`  (
  ...
  `Remark` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注',
  `IsAllowOut` bit DEFAULT NULL COMMENT '允许出库标记',
...
CREATE TABLE `wmsinstockrecdtbl`  (
  ...
  `UnusualFlg` bit DEFAULT NULL COMMENT '异常标识',
...
CREATE TABLE `wmsinstockrectbl`  (
  ...
  `Remark` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注',
  `Enable` bit NOT NULL DEFAULT 1 COMMENT '有效标志(SYS_ACTIONFLAG)',
  `IsBatch` bit NOT NULL DEFAULT 0 COMMENT '是否整批处理',
...
CREATE TABLE `wmsloadingdocdtbl`  (
  ...
  `BackFlg` bit NOT NULL DEFAULT 0 COMMENT '退回标示',
  `CreateTime` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `CreateUserId` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人ID',
  `CreateUserName` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人',
  `UpdateTime` datetime(0) DEFAULT NULL COMMENT '最后更新时间',
...
CREATE TABLE `wmsloadingdoctbl`  (
  ...
  `ActionFlg` bit NOT NULL DEFAULT 0 COMMENT '有效标识',
  `OwnerId` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '货主',
...
CREATE TABLE `wmsloadingnoticetbl`  (
  ...
  `VechileFee` bit NOT NULL DEFAULT 0 COMMENT '特殊收费 ',
...
CREATE TABLE `wmsmovetaskdtbl`  (
  ...
  `IsAllowOut` bit NOT NULL DEFAULT 0 COMMENT '允许出库标记',
...
CREATE TABLE `wmsmovetasktbl`  (
  ...
  `Remark` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注',
  `InOutType` bit NOT NULL DEFAULT 1 COMMENT '移入移出类型（1移入，2移出）',
  `CreateTime` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `CreateUserId` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人ID',
  `CreateUserName` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人',
  `UpdateTime` datetime(0) DEFAULT NULL COMMENT '最后更新时间',
...
CREATE TABLE `wmsoutboundordertbl`  (
  ...
  `IsUrgency` bit NOT NULL DEFAULT 0 COMMENT '加急否(0:否,1:是)',
  `IsPayNeed` bit NOT NULL DEFAULT 0 COMMENT '是否需要收款(0:否,1:是)',
  `IsOrderMerged` bit NOT NULL DEFAULT 0 COMMENT '订单合并标识(0:否,1:是)',
  `Remark` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注',
  ...
  `Treator` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '经办人',
  `IsBatch` bit NOT NULL DEFAULT 0 COMMENT '是否整批处理(0:否,1:是)',
  `Enable` bit NOT NULL DEFAULT 0 COMMENT '有效标志(SYS_ACTIONFLAG)',
  `RequireDate` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '要求到货日期',
  `ErpAddressFlg` bit NOT NULL DEFAULT 0 COMMENT '是否指定地址(0:否,1:是)',
...
CREATE TABLE `wmsoutboundpicktaskdtbl`  (
  ...
  `OwnerId` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '货主',
  `CheckFlg` bit NOT NULL DEFAULT 0 COMMENT '复核标记',
  ...
  `CheckError` bit NOT NULL DEFAULT 0 COMMENT '复核异常',
  ...
  `RepTaskFlg` bit NOT NULL DEFAULT 0 COMMENT '补货标记',
...
CREATE TABLE `wmsoutboundpicktasktbl`  (
  ...
  `RepTaskFlg` bit NOT NULL DEFAULT 0 COMMENT '补货标记',
  `MultiCustJoinFlg` bit NOT NULL DEFAULT 0 COMMENT '多客户拼箱标记',
  ...
  `BufferFlg` bit NOT NULL DEFAULT 0 COMMENT '是否进缓存标记',
  ...
  `FillFlg` bit NOT NULL DEFAULT 0 COMMENT '补流程标记(0:否,1:是)',
  `CreateTime` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `CreateUserId` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人ID',
  `CreateUserName` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人',
  `UpdateTime` datetime(0) DEFAULT NULL COMMENT '最后更新时间',
...
CREATE TABLE `wmsownermst`  (
  ...
  `PrintOrder` bit NOT NULL DEFAULT 0 COMMENT '是否打印随货通行单',
  `ShowPrice` bit NOT NULL DEFAULT 0 COMMENT '发货单是否显示价格',
  `CreateTime` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `CreateUserId` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人ID',
  `CreateUserName` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人',
  `UpdateTime` datetime(0) DEFAULT NULL COMMENT '最后更新时间',
...
CREATE TABLE `wmsshippermst`  (
  ...
  `IsBarcodePrint` bit NOT NULL DEFAULT 0 COMMENT '是否打印条码标志',
  `Enable` bit NOT NULL DEFAULT 0 COMMENT '有效标志(SYS_ACTIONFLAG)',
...
CREATE TABLE `wmsstockadjdtbl`  (
  ...
  `BoxId` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '箱号',
  `InBatchCode` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '入库批次(*)',
  `AllowOut` bit DEFAULT NULL COMMENT '允许出库标记',
