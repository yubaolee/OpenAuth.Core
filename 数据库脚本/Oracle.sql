...
COMMENT ON COLUMN Stock.CreateUser IS '操作人';
...
ALTER TABLE Stock ADD CONSTRAINT SYS_C0023944 CHECK (CreateUser IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
