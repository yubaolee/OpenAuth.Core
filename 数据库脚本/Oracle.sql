...
COMMENT ON COLUMN BuilderTable.Remark IS '表描述、中文名称';
...
COMMENT ON COLUMN BuilderTableColumn.Remark IS '列描述';
...
DISABLE ROW MOVEMENT
;
COMMENT ON COLUMN SysResource.Id IS '资源标识';
COMMENT ON COLUMN SysResource.CascadeId IS '节点语义ID';
COMMENT ON COLUMN SysResource.Name IS '名称';
COMMENT ON COLUMN SysResource.SortNo IS '排序号';
COMMENT ON COLUMN SysResource.Description IS '描述';
COMMENT ON COLUMN SysResource.ParentName IS '父节点名称';
COMMENT ON COLUMN SysResource.ParentId IS '父节点流ID';
COMMENT ON COLUMN SysResource.AppId IS '资源所属应用ID';
COMMENT ON COLUMN SysResource.AppName IS '所属应用名称';
COMMENT ON COLUMN SysResource.TypeName IS '分类名称';
COMMENT ON COLUMN SysResource.TypeId IS '分类ID';
COMMENT ON COLUMN SysResource.Disable IS '是否可用';
COMMENT ON COLUMN SysResource.CreateTime IS '创建时间';
COMMENT ON COLUMN SysResource.CreateUserId IS '创建人ID';
COMMENT ON COLUMN SysResource.CreateUserName IS '创建人';
COMMENT ON COLUMN SysResource.UpdateTime IS '最后更新时间';
COMMENT ON COLUMN SysResource.UpdateUserId IS '最后更新人ID';
COMMENT ON COLUMN SysResource.UpdateUserName IS '最后更新人';
COMMENT ON TABLE SysResource IS '资源表';

-- ----------------------------
-- Records of Resource
-- ----------------------------
INSERT INTO SysResource VALUES ('SYS_VIEW_USER', '.0.3.', '查看用户列表', '0', '查看OpenAuth.Net用户列表', '根节点', NULL, '110', 'OpenAuth.Net', NULL, NULL, '0', TO_DATE('2019-11-23 00:44:39', 'SYYYY-MM-DD HH24:MI:SS'), '6ba79766-faa0-4259-8139-a4a6d35784e0', 'test', TO_DATE('2019-11-23 00:44:39', 'SYYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO SysResource VALUES ('XXX_ADDORDER', '.0.6.', '创建订单', '0', '在XXX平台创建订单', '根节点', NULL, '119', 'XXX管理平台', NULL, NULL, '0', TO_DATE('2019-11-23 00:53:24', 'SYYYY-MM-DD HH24:MI:SS'), '6ba79766-faa0-4259-8139-a4a6d35784e0', 'test', TO_DATE('2019-11-23 00:53:24', 'SYYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO SysResource VALUES ('XXX_DEL_LOG', '.0.4.', '删除XXX平台日志', '0', '删除XXX平台日志', '根节点', NULL, '119', 'XXX管理平台', NULL, NULL, '0', TO_DATE('2019-11-23 00:45:02', 'SYYYY-MM-DD HH24:MI:SS'), '6ba79766-faa0-4259-8139-a4a6d35784e0', 'test', TO_DATE('2019-11-23 00:45:02', 'SYYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO SysResource VALUES ('XXX_LOGIN', '.0.7.', '登录', '0', '登录XXX平台', '根节点', NULL, '119', 'XXX管理平台', NULL, NULL, '0', TO_DATE('2019-11-23 00:55:20', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', '超级管理员', TO_DATE('2019-11-23 00:55:20', 'SYYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO SysResource VALUES ('XXX_VIEW_USER', '.0.5.', '查看用户', '0', '查看XXX平台用户列表', '根节点', NULL, '119', 'XXX管理平台', NULL, NULL, '0', TO_DATE('2019-11-23 00:53:01', 'SYYYY-MM-DD HH24:MI:SS'), '6ba79766-faa0-4259-8139-a4a6d35784e0', 'test', TO_DATE('2019-11-23 00:53:01', 'SYYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO SysResource VALUES ('SYS_DEL_USER', '.0.2.', '删除用户', '0', '拥有删除OpenAuth.Net系统用户信息的权限', '根节点', NULL, '110', 'OpenAuth.Net', NULL, NULL, '0', TO_DATE('2019-11-23 00:27:58', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', '超级管理员', TO_DATE('2019-11-23 00:27:58', 'SYYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO SysResource VALUES ('SYS_UPDATE_USER', '.0.1.', '更新用户信息', '0', '拥有更新OpenAuth.Net系统用户信息的权限', '根节点', NULL, '110', 'OpenAuth.Net', NULL, NULL, '0', TO_DATE('2019-11-23 00:27:17', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', '超级管理员', TO_DATE('2019-11-23 00:27:12', 'SYYYY-MM-DD HH24:MI:SS'), NULL, NULL);
...
CREATE TABLE Stock (
  ...
  ProdCnt NUMBER(11,0) NOT NULL,
  Price NUMBER NOT NULL,
  Status NUMBER(11,0) NOT NULL,
  Viewable VARCHAR2(50 ) NOT NULL,
  SysUser VARCHAR2(50 ) NOT NULL,
  Time DATE NOT NULL,
  OrgId VARCHAR2(50 )
)
LOGGING
...
DISABLE ROW MOVEMENT
;
COMMENT ON COLUMN SysUser.Id IS '流水号';
COMMENT ON COLUMN SysUser.Account IS '用户登录帐号';
COMMENT ON COLUMN SysUser.Password IS '密码';
COMMENT ON COLUMN SysUser.Name IS '用户姓名';
COMMENT ON COLUMN SysUser.Sex IS '性别';
COMMENT ON COLUMN SysUser.Status IS '用户状态';
COMMENT ON COLUMN SysUser.BizCode IS '业务对照码';
COMMENT ON COLUMN SysUser.CreateTime IS '经办时间';
COMMENT ON COLUMN SysUser.CreateId IS '创建人';
COMMENT ON COLUMN SysUser.TypeName IS '分类名称';
COMMENT ON COLUMN SysUser.TypeId IS '分类ID';
COMMENT ON COLUMN SysUser.ParentId IS '直属上级';
COMMENT ON TABLE SysUser IS '用户基本信息表';

-- ----------------------------
-- Records of User
-- ----------------------------
INSERT INTO SysUser VALUES ('0ceff0f8-f848-440c-bc26-d8605ac858cd', 'test5', 'test5', 'test5', '1', '1', NULL, TO_DATE('2022-03-15 09:19:05', 'SYYYY-MM-DD HH24:MI:SS'), NULL, NULL, NULL, '6ba79766-faa0-4259-8139-a4a6d35784e0');
INSERT INTO SysUser VALUES ('1df68dfd-3b6d-4491-872f-00a0fc6c5a64', 'test4', 'test4', 'test4', '1', '1', NULL, TO_DATE('2022-12-12 14:07:11', 'SYYYY-MM-DD HH24:MI:SS'), NULL, NULL, NULL, '6ba79766-faa0-4259-8139-a4a6d35784e0');
INSERT INTO SysUser VALUES ('229f3a49-ab27-49ce-b383-9f10ca23a9d5', 'test3', 'test3', 'test3', '1', '0', NULL, TO_DATE('2022-12-12 14:07:05', 'SYYYY-MM-DD HH24:MI:SS'), NULL, NULL, NULL, '6ba79766-faa0-4259-8139-a4a6d35784e0');
INSERT INTO SysUser VALUES ('49df1602-f5f3-4d52-afb7-3802da619558', 'admin', 'admin', 'admin', '1', '0', NULL, TO_DATE('2022-12-11 16:18:54', 'SYYYY-MM-DD HH24:MI:SS'), NULL, NULL, NULL, NULL);
INSERT INTO SysUser VALUES ('6ba79766-faa0-4259-8139-a4a6d35784e0', 'test', 'test', 'test', '1', '0', NULL, TO_DATE('2022-12-11 16:19:00', 'SYYYY-MM-DD HH24:MI:SS'), NULL, NULL, NULL, '49df1602-f5f3-4d52-afb7-3802da619558');
INSERT INTO SysUser VALUES ('758a34c7-5a31-438c-bdf7-02fdd846b901', 'test77', 'test77', 'test77', '0', '0', NULL, TO_DATE('2022-10-31 21:59:08', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', NULL, NULL, NULL);
INSERT INTO SysUser VALUES ('96f63f9d-e8c8-4258-963e-3327ed7d6f56', 'test66', 'test66', 'test66', '0', '0', NULL, TO_DATE('2022-10-31 21:58:43', 'SYYYY-MM-DD HH24:MI:SS'), '00000000-0000-0000-0000-000000000000', NULL, NULL, NULL);
INSERT INTO SysUser VALUES ('de8be521-f1ec-4483-b124-0be342890507', 'test2', 'test2', 'test2', '1', '0', NULL, TO_DATE('2022-12-11 16:19:06', 'SYYYY-MM-DD HH24:MI:SS'), NULL, NULL, NULL, '49df1602-f5f3-4d52-afb7-3802da619558');
...
-- ----------------------------
ALTER TABLE SysResource ADD CONSTRAINT PK__RESOURCE PRIMARY KEY (Id);

-- ----------------------------
-- Checks structure for table Resource
-- ----------------------------
ALTER TABLE SysResource ADD CONSTRAINT SYS_C0023925 CHECK (Id IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE SysResource ADD CONSTRAINT SYS_C0023926 CHECK (CascadeId IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE SysResource ADD CONSTRAINT SYS_C0023927 CHECK (Name IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE SysResource ADD CONSTRAINT SYS_C0023928 CHECK (SortNo IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE SysResource ADD CONSTRAINT SYS_C0023929 CHECK (Description IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE SysResource ADD CONSTRAINT SYS_C0023930 CHECK (Disable IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE SysResource ADD CONSTRAINT SYS_C0023931 CHECK (CreateTime IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE SysResource ADD CONSTRAINT SYS_C0023932 CHECK (CreateUserId IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE SysResource ADD CONSTRAINT SYS_C0023933 CHECK (CreateUserName IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
...
ALTER TABLE Stock ADD CONSTRAINT SYS_C0023940 CHECK (ProdCnt IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
...
ALTER TABLE Stock ADD CONSTRAINT SYS_C0023944 CHECK (SysUser IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
...
-- ----------------------------
ALTER TABLE SysUser ADD CONSTRAINT PK_USER PRIMARY KEY (Id);

-- ----------------------------
-- Checks structure for table User
-- ----------------------------
ALTER TABLE SysUser ADD CONSTRAINT SYS_C0023966 CHECK (Id IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE SysUser ADD CONSTRAINT SYS_C0023967 CHECK (Account IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE SysUser ADD CONSTRAINT SYS_C0023968 CHECK (Password IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE SysUser ADD CONSTRAINT SYS_C0023969 CHECK (Name IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE SysUser ADD CONSTRAINT SYS_C0023970 CHECK (Status IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE SysUser ADD CONSTRAINT SYS_C0023971 CHECK (CreateTime IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Primary Key structure for table WmsInboundOrderDtbl
-- ----------------------------
ALTER TABLE WmsInboundOrderDtbl ADD CONSTRAINT PK__WMSINBOUNDORDERDTBL PRIMARY KEY (Id);
